...
static const char *fonts[]          = { "NovaMono for Powerline:weight=bold:size=11:antialias=true:hinting=true",
...
/* static const char col_cyan[]        = "#98b7c0"; */
...
static const char *tagsalt[] = { "I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X" };
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-c", "-p", "RUN:", "-l", "15", NULL };
